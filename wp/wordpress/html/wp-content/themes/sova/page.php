       ...
       <section class="contact_page">
         <div class="common_wrap">
           <div class="common_inner_s">
             <h1 class="terms_title">
               プライバシーポリシー
             </h1>
             <p class="terms_title_en">
               PRIVACY POLICY
             </p>
             <div class="terms_wrap">
               <div class="terms_block">
                 <p class="terms_block_text">
                   合同会社FIELDは、システム開発、WEBマーケティング・コンサルタント、飲食店経営事業を実施する上で、お客様の個人情報がプライバシーを構成する重要な情報であることを深く認識し、業務において個人情報を取り扱う場合には、個人情報に関する法令及び個人情報保護のために定めた社内規定を定め、また、組織体制を整備し、個人情報の適切な保護に努めることにより、お客様を尊重し、当社に対する期待と信頼に応えていきます。
                 </p>
               </div>
               <div class="terms_block">
                 <h2 class="terms_block_title">
                   個人情報の取得、利用、提供
                 </h2>
                 <p class="terms_block_text">
               ...
               <div class="terms_enactment_block">
                 <p class="terms_text t_right">
                   2021年4月28日　制定<br>
                   合同会社FIELD<br>
                   代表社員　山本　祐也
                 </p>
               </div>
               <div class="terms_contact_block">
                 <div class="terms_contact_block_inner">
                   <h2 class="terms_contact_title">
                     ＜個人情報保護に関する連絡先＞
                   </h2>
                   <p class="terms_contact_text">
                     個人情報問合せ窓口<br>
                     個人情報保護管理者　嶋津　也枝<br>
                     TEL 03-6820-0781
                   </p>
